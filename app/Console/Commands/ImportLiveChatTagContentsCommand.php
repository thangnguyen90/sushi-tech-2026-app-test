...
class ImportLiveChatTagContentsCommand extends Command implements ShouldQueue, ShouldBeUnique
{
    use CsvTrait;
     ...
     * @var string
     */
    protected $signature = 'live_chat_tag_contents {file : The CSV file to import}';
